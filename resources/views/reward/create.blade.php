...
@section('subhead')
<title>Add New Reward - Midone - Tailwind HTML Admin Template</title>
@endsection

@section('subcontent')
<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    <h2 class="text-lg font-medium mr-auto">Add New Reward</h2>
</div>
        ...
        <form method="POST" action="{{ route('reward-store') }}" enctype="multipart/form-data">
            ...
            <div class="intro-y box p-5">
                ...
                <div class="mt-3">
                    ...
                    <input id="update-profile-form-7" name="reward" class="form-control" placeholder="Masukan jenis/nama Reward">
                    @error('reward')
                    <div class="invalid-feedback" style="color: red;">*{{ $message }}</div>
                    @enderror
                </div>
