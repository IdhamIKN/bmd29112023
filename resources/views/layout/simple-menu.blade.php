    ...
    <div class="flex mt-[4.7rem] md:mt-0">
        ...
        <nav class="side-nav side-nav--simple">
            ...
            <ul>
                ...
                @if (auth()->user()->hasRole('superadmin') || (auth()->user()->hasRole('admin',) && isset($menu['admin_visible']) && $menu['admin_visible']) || (auth()->user()->hasRole('user') && isset($menu['user_visible']) && $menu['user_visible']))
                @if ($menu == 'devider')
